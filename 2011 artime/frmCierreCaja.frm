...
Private Sub cmdCerrar_Click()
    ...
    txtEfvo = FormatCurrency(Efvo, , , , vbFalse)
    VarCaja = PC.UltVarCuenta(78)
    
    If MsgBox("Está a punto de cerrar caja por " + FormatCurrency(CSng(txtEfvo), , , , vbFalse) + _
    ...
    Label12 = FormatCurrency(Efvo - CajaSup, , , , vbFalse)
    ...
    ACC.RegEvento UUs, 2, "Caja Cerrada" + _
        ". Efectivo: " + FormatCurrency(tmpEf, , , , vbFalse) + _
        ". Dif Caja: " + FormatCurrency(tmpDif, , , , vbFalse)
...
Private Sub Command2_Click()
    txtEfvo = FormatCurrency(ValidarNumeros(txtEfvo), , , , vbFalse)
    ...
    Label7 = "Hay un " + TmP + " de " + _
        FormatCurrency(Abs(Efvo - CajaSup), , , , vbFalse) + "." + vbCrLf + _
...
Private Sub Form_Load()
    ...
    lblEI = FormatCurrency(PC.MovCerrados(78), , , , vbFalse)
    ...
    lvCierre.ListItems(tmp2).SubItems(3) = FormatCurrency(SubD, , , , vbFalse)
    ...
    lblVariacion = FormatCurrency(Abs(VariacionCaja), , , , vbFalse)
...
Private Sub Form_QueryUnload(Cancel As Integer, UnloadMode As Integer)
    If Cerrado Then MsgBox "Quedá registrado en Caja " + _
        FormatCurrency(PC.ABSSumarconSubcuentas(78), , , , vbFalse) + _
