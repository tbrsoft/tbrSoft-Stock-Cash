        ...
        Case 0 'SISTEMA ---------------------------------------------------------------------
            Select Case SubIndice
                ...
                Case 9 '...........................................................................
                    ...
                    MsgBox "Indique dónde esta el archivo que recibió de tbrSoft", vbInformation, "Insertar Licencia"
                    ...
                    If FSO.FileExists(F) = False Then
                        MsgBox "Archivo inexistente", vbExclamation, "Atención"
                        Exit Sub
                    End If
                    ...
                    If LIC.GetLic < Licencia1 Then
                        MsgBox "¡No es una licencia válida! " + CStr(CLng(LIC.GetLic)), vbExclamation, "Atención"
                    End If
                    
                    If LIC.GetLic = Licencia1 Then
                        MsgBox "Se insertó una Licencia Simple", vbInformation, "Licencia Simple"
                    End If
                    
                    If LIC.GetLic = Licencia2 Then
                        MsgBox "Se insertó una Licencia Express", vbInformation, "Licencia Express"
                    End If
                    
                    If LIC.GetLic = Licencia3 Then
                        MsgBox "Se insertó una SuperLicecnia", vbInformation, "SuperLicencia"
                    End If
